        ...
        if (args[0]) {
            ...
            if (comando) {
                let embed = new Discord.MessageEmbed()
                    ...
                    .setFooter({ text: `© Desarrollado por fercho31#5940 | 2022`, iconURL: `https://cdn.discordapp.com/attachments/498999790546190347/960244857115398184/unknown.png` })
            ...
            .setColor(client.color)
            .setDescription(`Bot Multifuncional`)
            .addField(`❓ **__¿Quién soy?__**`, `<a:wwave:961415204141432922> Hola **${message.author.username}**, mi nombre es **__${client.user.username}__**\n🤯 Soy un BOT MULTIFUNCIONAL Incluyendo:\n> <a:controller:961413958605094922> **MULTIMEDIA**\n> ⚔ MODERACIÓN\n> <a:music:960705666354389104> **MÚSICA**\n*y mucho más!*`)
            .addField(`📈 **__ESTADÍSTICAS__**`, `<a:gearSpinning:961412839380238367> **${client.commands.size} Comandos**\n📁 en **${client.guilds.cache.size} Servidores**\n📶 **\`${client.ws.ping}ms\` Ping**\n👤 Desarrollado por **[fercho31#5940](https://discord.gg/adsaDa)**`)
            .addField(`✍ **__STARSCITYRP__**`, `[\`Servidor de RolePlay.\`](https://discord.gg/dbRYZnxzxb)`)
            .setThumbnail(message.guild.iconURL({ dynamic: true }))
            .setFooter({ text: `Página 1 / ${categorias.length+1}\n© Bot Multifuncional | 2022`, iconURL: `https://cdn.discordapp.com/attachments/498999790546190347/960244857115398184/unknown.png` })
            ...
            categorias.map((categoria, index) => {
                ...
                let embed = new Discord.MessageEmbed()
                    ...
                    .setThumbnail(message.guild.iconURL({ dynamic: true }))
                    .setDescription(comandos_de_categoria.length >= 1 ? `>>> *${comandos_de_categoria.map(comando => `\`${comando.replace(/.js/, "")}\``).join(" - ")}*` : `>>> *Todavía no hay comandos en esta categoría...*`)
                    .setFooter({ text: `Página ${index+2} / ${categorias.length+1}\n© desarrollado por fercho31#5940 | 2022`, iconURL: `https://cdn.discordapp.com/attachments/498999790546190347/960244857115398184/unknown.png` })
            ...
            const botones = new Discord.MessageActionRow().addComponents([
                new Discord.MessageButton().setStyle('SUCCESS').setLabel("Atrás").setCustomId("Atrás").setEmoji("960709028818849912"),
                new Discord.MessageButton().setStyle('PRIMARY').setLabel("Inicio").setCustomId("Inicio").setEmoji("🏠"),
                new Discord.MessageButton().setStyle('SUCCESS').setLabel("Avanzar").setCustomId("Avanzar").setEmoji("960708995851644938"),
            ])
